...
import { renderSlide } from './renderer.js?v=1779983429';
import { applyCSSVariables } from './theme.js?v=1779983429';
import { mountWhiteboard, unmountWhiteboard, setWhiteboardSlide } from './whiteboard.js?v=1779983429';
import { parseHash, buildHash } from './hash-params.js?v=1779983429';
...
import { decryptContent } from './decrypt-runtime.js?v=1779983429';
import { resolveEncryptedMedia } from './asset-decrypt.js?v=1779983429';
    ...
    if ('serviceWorker' in navigator) {
      ...
      if (isDev) {
        ...
        window.addEventListener('load', () => {
          navigator.serviceWorker.register('./sw.js?v=1779983429');
        });
      }
    }
  } catch (err) {
